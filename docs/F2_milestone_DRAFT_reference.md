---
title: "F2 milestone DRAFT (AI reference) — rewrite with your own results"
...
# F2 milestone DRAFT (AI reference — do not treat as yours)

> **NOTE:** This draft records an AI reference implementation (git `529ab9d`),
> written before the workflow was corrected. Implement F2 yourself per the
> tutorial, then rewrite this milestone with *your* numbers and war stories.

## (reference) From O(N³) dense to matrix-free CG-FFT
