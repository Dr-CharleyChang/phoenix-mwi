...
**Current stage: F1 — 2D Method-of-Moments forward solver, validated against the
analytic Mie series.**
...
│   ├── operators.py    # matrix-free A_op / AH_op        (F2, stub)
...
├── tests/
│   └── test_f1.py      # self-test checklist T1-T8 (turns green as you implement)
...
| F2 | CG-FFT acceleration (matrix-free + Toeplitz) | ⏳ |
